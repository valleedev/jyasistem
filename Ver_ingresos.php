...
$sql="select * from ingresos ORDER BY no_recibo desc";
...
<form action="./Buscar_ingresos_valor.php" method="post">
	...
	<div class="fields">
	  ...
	  <div class="input-field">
		...
		<input class="input" type="number" id="valor" placeholder="valor" name="valor" >
	 </div>
