...
<form action="./Buscar_usuarios_nombre_completo.php" method="post">
	...
	<div class="fields">
	  ...
	  <input class="input" type="text" id="nombre_completo" placeholder="Ingrese su nombre completo" name="nombre_completo" required >
	 </div>
