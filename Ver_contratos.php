...
$sql="select * from contratos ORDER BY fecha_inicio desc";
...
<form action="./Buscar_contratos_fecha_inicio.php" method="post">
	...
	<div class="fields">
		...
		<div class="input-field">
	      <input class="input" type="date" id="date" placeholder="Ingrese la fecha de inicio" name="fecha_inicio" required>
	   </div>
