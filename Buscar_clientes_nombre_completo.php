...
$sql="select * from clientes where nombre_completo LIKE '%".$_POST["nombre_completo"]."%'";
...
{ /*almacenamos el nombre de la ruta en la variable $ruta_img*/ 
 ...
 ?>
   ...
   <td> 
            <form  action="Eliminar_clientes.php" method="post" onsubmit="return pregunta();"><input type = "hidden" value="<?php echo $row["cedula"]; ?> " name="cedula">
